...
export async function renderRatesMap(element, points, labels) {
    ...
    // The panel is morphed on every filter change, which can hand this the same element twice.
    ...
    const markers = points.map((point) => {
        ...
        return L.marker([point.lat, point.lng], {
            icon,
            title: point.name,
            // Yerevan holds most of the branches, so labels overlap at the opening zoom.
            riseOnHover: true,
