...
<figure {{ $attributes->merge(['class' => 'min-w-0']) }}>
    <div class="overflow-x-auto">
        ...
        >
            {{-- Four faint guides, so a reader can judge a slope rather than only see one. --}}
            ...
            @foreach ($lines as $key => $line)
                ...
                @if ($points !== '')
                    ...
                    {{-- The last point marked: "where it is now" is the thing most readers are actually looking for. --}}
