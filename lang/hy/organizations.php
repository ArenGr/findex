...
return [
    ...
    'rates_heading' => 'Փոխարժեքներ',
    'rates_updated' => 'Փոխարժեքները թարմացվել են :time',
    'rates_none' => ':name-ը դեռ չի հրապարակել փոխարժեքներ։',
    'rates_see_all' => 'Տեսնել բոլոր :code փոխարժեքները',
