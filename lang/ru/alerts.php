...
return [
    ...
    'modal' => [
        'subtitle' => 'Укажите нужный курс, и мы уведомим вас сразу, как только он наступит.',
        'sign_in_required' => 'Уведомления о курсе привязаны к вашему аккаунту, поэтому сначала войдите - мы вернём вас прямо к этим курсам.',
        'sign_in' => 'Войти',
        'cancel' => 'Отмена',
        'direction_below' => 'Опустится ниже',
        'direction_above' => 'Поднимется выше',
        'threshold_placeholder' => 'напр. 360.00',
        'current_rate' => 'Сейчас лучший',
        'manage' => 'Управлять уведомлениями',
        'channel_question' => 'Как вас уведомить?',
        'more_channels' => 'Подключите Telegram или Viber, чтобы получать уведомления там',
    ],
    'form' => [
        'currency' => 'Валюта',
        'organization' => 'Банк',
