...
return [
    ...
    'questions' => [
        [
            ...
            'answer' => "No. Findex is an independent comparison service - we don't hold your money, issue cards, or underwrite policies. We show you what banks, lenders and travel agencies publish, so you can compare and choose.",
        ],
        [
            'question' => 'How often are rates updated?',
            'answer' => "Currency, mortgage and card rates are checked automatically throughout the day, so what you see reflects what banks are currently publishing - not last week's numbers.",
        ],
        [
        ...
        [
            ...
            'answer' => "No - just an email address. If you do sign in first, your requests are saved to a \"My Trips\" page so you don't have to keep track of the results link yourself.",
        ],
        [
            'question' => 'What happens to my trip details when I request travel quotes?',
        ...
        [
            ...
            'answer' => "No. We don't sell personal data. See our Privacy Policy for exactly what we collect, how we use it, and the one case where we share trip details with travel agencies you've asked us to contact.",
        ],
    ],
];
