...
class OpeningHoursTest extends TestCase
{
    ...
    // The rules arrive as one HTML blob.
    ...
    // Araratbank prints both rules on one unbroken line, with nothing but a space between them.
    ...
    // ACBA lists the cash desk on its own line, closing an hour before the branch does.
    ...
    // Unknown is not the same as closed, and the UI renders them differently.
